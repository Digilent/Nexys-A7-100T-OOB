...
2. Open the project in Vivado 2020.1 by double clicking on the included XPR file found at "\<archive extracted location\>/Nexys-A7-100T-OOB/Nexys-A7-100T-OOB.xpr".
...
8. In the Program Device Wizard, enter "\<archive extracted location\>/Nexys-A7-100T-OOB/Nexys-A7-100T-OOB.runs/impl_1/Nexys4DdrUserDemo.bit" into the "Bitstream file" field. Then click **Program**.
